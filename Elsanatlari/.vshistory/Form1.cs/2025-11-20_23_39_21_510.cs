	...
	public partial class Form1 : Form
	{
		...
		private void BtnHareketSil_Click(object sender, EventArgs e)
		{
			...
			using (var connection = new SqliteConnection(connectionString))
			{
				...
				try
				{
					// Seçili hareketin UrunId'sini bul
					...
					// 1. Stok tablosunda ters işlem yap (Stok Dengeleme)
					var cmdS = connection.CreateCommand();
					cmdS.Transaction = trans;
		...
		private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
		{
			if (e.RowIndex >= 0)
			{
				...
				// TxtHareketId kullanımı güvenli olmadığı için kaldırıldı.
			}
		}

		// *** DÜZELTİLMİŞ METOT: button1_Click (Hareket Sil) ***
		private void button1_Click(object sender, EventArgs e)
		{
			...
			// *** ÖNEMLİ DÜZELTME: İşlem sonrası listeleri yenile ***
			HareketleriListele();
			UrunleriListele();
		}
