...
namespace Elsanatlari
{
	public partial class Form1 : Form
	{
		...
		{
			// *** Null Kontrolleri Eklendi (Güvenlik) ***
			...
			using (var connection = new SqliteConnection(connectionString))
			{
				...
				// cmbHareketFiltre sadece string içerir.
				string hareketTuru = cmbHareketFiltre.SelectedItem.ToString();

				// CmbUrunFiltre sadece ComboboxItem içerir (Çözüm: Artık string seçenekleri bu ComboBox'a eklenmiyor).
